...
U_CAPI void    U_EXPORT2 ucnv_setToUCallBack_50 (UConverter * converter,
                            UConverterToUCallback newAction,
                            const void* newContext,
                            UConverterToUCallback *oldAction,
                            const void** oldContext,
...
U_CAPI void  U_EXPORT2 ucnv_close_50 (UConverter * converter) {
  ucnv_close (converter);
}

U_CAPI void  U_EXPORT2
ucnv_setFromUCallBack_50 (UConverter * converter,
                            UConverterFromUCallback newAction,
                            const void* newContext,
                            UConverterFromUCallback *oldAction,
                            const void** oldContext,
...
U_CAPI void U_EXPORT2
ucnv_convertEx_50 (UConverter *targetCnv, UConverter *sourceCnv,
               char **target, const char *targetLimit,
               const char **source, const char *sourceLimit,
               UChar *pivotStart, UChar **pivotSource,
               UChar **pivotTarget, const UChar *pivotLimit,
...
U_CAPI UConverter* U_EXPORT2
ucnv_open_50 (const char *name,
                       UErrorCode * err) {
  return ucnv_open(name, err);
}

U_STABLE void U_EXPORT2 UCNV_FROM_U_CALLBACK_STOP_50 (
                  const void *context,
                  UConverterFromUnicodeArgs *fromUArgs,
                  const UChar* codeUnits,
                  int32_t length,
...
U_STABLE void U_EXPORT2 UCNV_TO_U_CALLBACK_STOP_50 (
                  const void *context,
                  UConverterToUnicodeArgs *toUArgs,
                  const char* codeUnits,
                  int32_t length,
